...
ColumnLayout {
  ...
  SettingsSurface {
    ...
    Toggle { Layout.fillWidth: true; label: "Show active status marker"; description: "Show the active marker beside active device icons in the bar."; checked: page.controller.showBarActiveMarker; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({showBarActiveMarker: !checked}) }
    Toggle { Layout.fillWidth: true; label: "Show disabled status marker"; description: "Show the disabled marker beside blocked or muted device icons in the bar."; checked: page.controller.showBarDisabledMarker; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({showBarDisabledMarker: !checked}) }
    Toggle { Layout.fillWidth: true; label: "Show verifying status marker"; description: "Show the verifying marker while a control action is pending."; checked: page.controller.showBarPendingMarker; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({showBarPendingMarker: !checked}) }
    Toggle { Layout.fillWidth: true; label: "Show degraded status marker"; description: "Show the degraded marker when a monitoring source is unhealthy."; checked: page.controller.showBarDegradedMarker; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({showBarDegradedMarker: !checked}) }
    ...
    Toggle { Layout.fillWidth: true; label: "Show state pills"; description: "Keep textual state visible beside each popup row."; checked: page.controller.showStatePills; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({showStatePills: !checked}) }
    Toggle { Layout.fillWidth: true; label: "Show popup session counts"; description: "Display a badge when several sessions share a popup item."; checked: page.controller.showSessionCounts; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({showSessionCounts: !checked}) }
    Toggle { Layout.fillWidth: true; label: "Show bar session counts"; description: "Append a count when several sessions share a bar item."; checked: page.controller.showBarSessionCounts; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({showBarSessionCounts: !checked}) }
    Toggle { Layout.fillWidth: true; label: "Animate verification"; description: "Pulse pending bar items until observed state confirms the action."; checked: page.controller.animatePending; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({animatePending: !checked}) }
