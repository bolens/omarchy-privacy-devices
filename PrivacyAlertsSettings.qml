...
ColumnLayout {
  ...
  SettingsSurface {
    ...
    Toggle { Layout.fillWidth: true; label: "Activity started"; description: "Notify when selected privacy activity begins."; checked: page.controller.setting("notifyOnActivity", true) === true; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({notifyOnActivity: !checked}) }
    Toggle { Layout.fillWidth: true; label: "Activity stopped"; description: "Notify when activity ends and include its duration."; checked: page.controller.setting("notifyOnStop", false) === true; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({notifyOnStop: !checked}) }
    Toggle { Layout.fillWidth: true; label: "Control results"; description: "Notify when privacy control changes succeed or fail."; checked: page.controller.setting("notifyOnControlChanges", true) === true; foreground: Color.popups.text; accent: page.controller.activeThemeColor; fontFamily: Style.font.family; onClicked: page.controller.persistSettings({notifyOnControlChanges: !checked}) }
